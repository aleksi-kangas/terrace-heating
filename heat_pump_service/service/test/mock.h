...
class MockCommunicator : public communicator::ICommunicator {
 public:
  ...
  MOCK_METHOD(communicator::BoostingSchedule, ReadCircuit3BoostingSchedule, (), (const, override));
  MOCK_METHOD(communicator::BoostingSchedule, ReadLowerTankBoostingSchedule, (), (const, override));
  MOCK_METHOD(communicator::Temperatures, ReadTemperatures, (), (const, override));
